...
doPlayerSendTextMessage(cid,18,'Você precisa estar na frente da porta.')
return 1
end
...
doPlayerSendTextMessage(cid,18,"Apenas Sorcerer's podem passar.")
end
...
doPlayerSendTextMessage(cid,18,"Apenas Druid's podem passar.")
end
...
doPlayerSendTextMessage(cid,18,"Apenas Paladin's podem passar.")
end
...
doPlayerSendTextMessage(cid,18,"Apenas Knight's podem passar.")
end
return 1
else
return 0
