...
function onUse(cid, item, fromPosition, itemEx, toPosition) 
	...
	local function SecondWave() 
		...
		doForceSummonCreature("Azerus1", {x=glo.x,y=glo.y - 5,z=glo.z}) 
		doForceSummonCreature("Rift Brood", {x= glo.x - 4,y=glo.y,z=glo.z}) 
		doForceSummonCreature("Rift Brood", {x= glo.x + 4,y=glo.y,z=glo.z}) 
		doForceSummonCreature("Rift Brood", {x=glo.x,y=glo.y + 4,z=glo.z}) 
		doForceSummonCreature("Rift Brood", {x=glo.x,y=glo.y - 4,z=glo.z}) 
		doForceSummonCreature("Rift Brood", {x=glo.x,y=glo.y + 5,z=glo.z}) 
	end 
	...
	local function ThirdWave() 
		...
		doForceSummonCreature("Azerus2", {x= glo.x - 5,y=glo.y,z=glo.z}) 
		doForceSummonCreature("Rift Scythe", {x= glo.x - 4,y=glo.y,z=glo.z}) 
		doForceSummonCreature("Rift Scythe", {x= glo.x + 4,y=glo.y,z=glo.z}) 
		doForceSummonCreature("Rift Scythe", {x= glo.x + 4,y=glo.y,z=glo.z}) 
		doForceSummonCreature("Rift Scythe", {x=glo.x,y=glo.y + 4,z=glo.z}) 
	end 

	local function ThirdWave1() --  with 2s delay 
		doForceSummonCreature("Rift Scythe", {x=glo.x,y=glo.y + 4,z=glo.z}) 
		doForceSummonCreature("Rift Scythe", {x=glo.x,y=glo.y - 4,z=glo.z}) 
		doForceSummonCreature("Rift Scythe", {x=glo.x,y=glo.y + 5,z=glo.z}) 
	end 

	local function FourthWave() 
		doForceSummonCreature("War Golem", {x= glo.x - 4,y=glo.y,z=glo.z}) 
		doForceSummonCreature("War Golem", {x= glo.x + 4,y=glo.y,z=glo.z}) 
		doForceSummonCreature("War Golem", {x=glo.x,y=glo.y - 4,z=glo.z}) 
		doForceSummonCreature("War Golem", {x=glo.x,y=glo.y + 4,z=glo.z}) 
	end 
	...
	local function SevenWave() 
		...
		doForceSummonCreature("Azerus3", {x= glo.x - 5,y=glo.y,z=glo.z}) 
		doForceSummonCreature("War Golem", {x= glo.x - 4,y=glo.y,z=glo.z}) 
		doForceSummonCreature("War Golem", {x= glo.x + 4,y=glo.y,z=glo.z}) 
		doForceSummonCreature("War Golem", {x=glo.x,y=glo.y - 4,z=glo.z}) 
		doForceSummonCreature("War Golem", {x=glo.x,y=glo.y + 4,z=glo.z}) 
