function onUse(cid, item, frompos, item2, topos)
	...
	if item.uid == 10544 then
		if getPlayerStorageValue(cid,10544) == -1 then
			doPlayerSendTextMessage(cid,18,"You have chosen an arcane staff.")
	...
	elseif item.uid == 10545 then
		if getPlayerStorageValue(cid,10544) == -1 then
			doPlayerSendTextMessage(cid,18,"You have chosen the avenger.")
 	...
 	elseif item.uid == 10546 then
		if getPlayerStorageValue(cid,10544) == -1 then
			doPlayerSendTextMessage(cid,18,"You have chosen an arbalest.")
	...
	elseif item.uid == 10547 then
		if getPlayerStorageValue(cid,10547) == -1 then
			doPlayerSendTextMessage(cid,18,"You have found a pair of soft boots.")
	...
	elseif item.uid == 10549 then
		if getPlayerStorageValue(cid,10549) == -1 then
			doPlayerSendTextMessage(cid,18,"You have found a stuffed dragon.")
	...
	elseif item.uid == 10550 then
		if getPlayerStorageValue(cid,10550) == -1 then
			doPlayerSendTextMessage(cid,18,"You have found a frozen starlight.")
	...
	elseif item.uid == 10559 then
		if getPlayerStorageValue(cid,10559) == -1 then
			doPlayerSendTextMessage(cid,18,"You have found 100 platinum coins.")
	...
	elseif item.uid == 10552 then
		if getPlayerStorageValue(cid,10552) == -1 then
			doPlayerSendTextMessage(cid,18,"You have found the holy Tible.")
	...
	elseif item.uid == 10548 then
		if getPlayerStorageValue(cid,23782) == -1 then
			doPlayerSendTextMessage(cid,18,"You have found a backpack of holding.")
