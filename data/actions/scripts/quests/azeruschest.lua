function onUse(cid, item, frompos, item2, topos) 
       ...
       if item.actionid == 58267 then 
           ...
           if queststatus == -1 then 
               doPlayerSendTextMessage(cid,18,"You have found an Yalahari Mask.") 
       ...
       elseif item.actionid == 58268 then 
           queststatus = getPlayerStorageValue(cid,102504) 
           if queststatus == -1 then 
               doPlayerSendTextMessage(cid,18,"You have found an Yalahari Armor.") 
       ...
       elseif item.actionid == 58269 then 
           queststatus = getPlayerStorageValue(cid,102504) 
           if queststatus == -1 then 
               doPlayerSendTextMessage(cid,18,"You have found an Yalahari Leg Piece.") 
