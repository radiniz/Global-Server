function onUse(cid, item, frompos, item2, topos)
	...
	if item.uid == 61904 then
		if getPlayerStorageValue(cid,61904) == -1 then
			doPlayerSendTextMessage(cid,18,"You have chosen an Jagged Sword.")
	...
	elseif item.uid == 61905 then
		if getPlayerStorageValue(cid,61904) == -1 then
			doPlayerSendTextMessage(cid,18,"You have chosen an Daramanian Mace.")
 	...
 	elseif item.uid == 61906 then
		if getPlayerStorageValue(cid,61904) == -1 then
			doPlayerSendTextMessage(cid,18,"You have chosen an Steel Axe.")
