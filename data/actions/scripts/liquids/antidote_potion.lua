...
config.removeOnUse = getConfigInfo(config.removeOnUse)
config.usableOnTarget = getConfigInfo(config.usableOnTarget)
config.realAnimation = getConfigInfo(config.realAnimation)
