local keywordHandler = KeywordHandler:new()
        ...
        local travelNode1 = keywordHandler:addKeyword({'passage'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'I can bring you back to Trade Quarter for 50 gold. Agreed?'})
        	travelNode1:addChildKeyword({'yes'}, StdModule.travel, {npcHandler = npcHandler, premium = false, level = 0, cost = 50, destination = {x=635, y=765, z=7}, msg = 'Okay. Enjoy!' })
		...
		local travelNode2 = keywordHandler:addKeyword({'yalahar'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'I can bring you back to Trade Quarter for 50 gold. Agreed?'})
        	travelNode2:addChildKeyword({'yes'}, StdModule.travel, {npcHandler = npcHandler, premium = false, level = 0, cost = 50, destination = {x=635, y=765, z=7}, msg = 'Okay. Enjoy!' })
        	...
        	travelNode3:addChildKeyword({'yes'}, StdModule.travel, {npcHandler = npcHandler, premium = false, level = 0, cost = 50, destination = {x=635, y=765, z=7}, msg = 'Okay. Enjoy!' })
