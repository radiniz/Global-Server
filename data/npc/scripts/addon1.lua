...
-- citizen (done)
local outfit_node = keywordHandler:addKeyword({'first elementalist addon'}, playerBuyAddonNPC, {premium = false, cost = 0, items = {{13756,1}}, outfit_female = 433, outfit_male = 432, addon = 1, storageID = 40009})
    outfit_node:addChildKeywordNode(yesNode)
    outfit_node:addChildKeywordNode(noNode)
local outfit_node = keywordHandler:addKeyword({'second elementalist addon'}, playerBuyAddonNPC, {premium = false, cost = 0, items = {{13940,1}}, outfit_female = 433, outfit_male = 432, addon = 2, storageID = 40006})
    outfit_node:addChildKeywordNode(yesNode)
    outfit_node:addChildKeywordNode(noNode)


keywordHandler:addKeyword({'addons'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'I can give you elementalist addons.'})
