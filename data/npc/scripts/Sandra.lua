...
function MageFirst(cid, message, keywords, parameters, node)
    ...
    if addon == -1 then
       if getPlayerItemCount(cid,59580) >= 1 then
        if doPlayerRemoveItem(cid,59580,1) then
...
node1 = keywordHandler:addKeyword({'mage fluid belt22200320'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To get mage fluid belt you need give me the winning lottery ticket. Do you have it with you?'})
node1:addChildKeyword({'yes'}, MageFirst, {})
node1:addChildKeyword({'no'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Alright then. Come back when you got all neccessary items.', reset = true})

node4 = keywordHandler:addKeyword({'maasdae'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To get mage fluid belt you need give me the winning lottery ticket. Do you have it with you?'})
