...
function creatureSayCallback(cid, type, msg)
	...
	elseif Topic[cid] == 7 and msgcontains(msg, 'no') then
		...
		Topic[cid] = 0
	elseif msgcontains(msg, 'csdada gold') then
	...
	elseif Topic[cid] == 8 then
		if getCount(msg) < 1 then
			...
			count[cid] = getCount(msg)
			npcHandler:say('So you would like me to csdada ' .. count[cid] * 100 .. ' of your gold coins into ' .. count[cid] .. ' platinum coins?', cid)
			Topic[cid] = 9
		end
	elseif Topic[cid] == 9 then
		...
		Topic[cid] = 0
	elseif msgcontains(msg, 'csdada platinum') then
		npcHandler:say('Would you like to csdada your platinum coins into gold or crystal?', cid)
		Topic[cid] = 10
	elseif Topic[cid] == 10 then
		if msgcontains(msg, 'gold') then
			npcHandler:say('How many platinum coins would you like to csdada into gold?', cid)
			Topic[cid] = 11
	...
	elseif Topic[cid] == 11 then
		if getCount(msg) < 1 then
			...
			count[cid] = getCount(msg)
			npcHandler:say('So you would like me to csdada ' .. count[cid] .. ' of your platinum coins into ' .. count[cid] * 100 .. ' gold coins for you?', cid)
			Topic[cid] = 12
		end
	...
	elseif Topic[cid] == 13 then
		if getCount(msg) < 1 then
			...
			count[cid] = getCount(msg)
			npcHandler:say('So you would like me to csdada ' .. count[cid] * 100 .. ' of your platinum coins into ' .. count[cid] .. ' crystal coins for you?', cid)
			Topic[cid] = 14
		end
	elseif Topic[cid] == 14 then
		...
		Topic[cid] = 0
	elseif msgcontains(msg, 'csdada crystal') then
		npcHandler:say('How many crystal coins would you like to csdada into platinum?', cid)
		Topic[cid] = 15
	elseif Topic[cid] == 15 then
		if getCount(msg) == -1 or getCount(msg) == 0 then
			...
			count[cid] = getCount(msg)
			npcHandler:say('So you would like me to csdada ' .. count[cid] .. ' of your crystal coins into ' .. count[cid] * 100 .. ' platinum coins for you?', cid)
			Topic[cid] = 16
		end
	elseif Topic[cid] == 16 then
		...
		Topic[cid] = 0
	elseif msgcontains(msg, 'csdada') then
		npcHandler:say('There are three different coin types in Tibia: 100 gold coins equal 1 platinum coin, 100 platinum coins equal 1 crystal coin. So if you\'d like to csdada 100 gold into 1 platinum, simply say \'{csdada gold}\' and then \'1 platinum\'.', cid)
		Topic[cid] = 0
	elseif msgcontains(msg, 'bank') then
		npcHandler:say('We can csdada money for you. You can also access your bank account.', cid)
		Topic[cid] = 0
	end
	return TRUE
end
