local keywordHandler = KeywordHandler:new()
        ...
        local travelNode = keywordHandler:addKeyword({'Farmine'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'So you want to go to Cormaya for 160 gold?'})
        	travelNode:addChildKeyword({'yes'}, StdModule.travel, {npcHandler = npcHandler, premium = false, level = 0, cost = 160, destination = {x=33025, y=31552, z=10} })
