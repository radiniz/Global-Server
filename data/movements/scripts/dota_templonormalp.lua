...
if doPlayerSetTown(cid, 1) then
  if(random_item == 2160) then
		       ...
		       doPlayerSendTextMessage(cid,18, 'Your team won the dota round! You winner: '.. config.crystal_counts ..' '.. item_name ..'s and dota winner medal!')
                else
                     doPlayerSendTextMessage(cid,18, 'Your team won the dota round! You winner: '.. item_name ..' and dota winner medal!')
